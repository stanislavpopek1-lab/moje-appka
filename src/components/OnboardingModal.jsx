  ...
  return (
    ...
    >
      <motion.div
        ...
        style={{
          border: "1px solid rgba(220,60,90,0.2)",
      ...
      >
        ...
        {step < steps.length - 1 ? (
          <div className="flex gap-3">
            <button
              onClick={handleLogin}
              className="flex-1 h-11 rounded-2xl glass text-sm font-medium text-muted-foreground hover:text-foreground hover:bg-white/5 transition-all"
            >
              Přihlásit se
            </button>
            ...
            <button
              ...
              style={{
                background:
                  "linear-gradient(135deg, hsl(42 90% 55%), hsl(35 80% 50%))",
                color: "hsl(35 25% 8%)",
              }}
            >
              Další
